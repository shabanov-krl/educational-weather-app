...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  void initState() {
    ...
    for (final city in _favorites) {
      _weatherFutures[city] = DIContainer.favoritesScreenRepository.getCurrentWeather(city);
    }
  ...
  void _addFavorite(String city) {
    ...
    setState(() {
      ...
      _weatherFutures[trimmed] = DIContainer.favoritesScreenRepository.getCurrentWeather(trimmed);
    });
    _controller.clear();
  }
