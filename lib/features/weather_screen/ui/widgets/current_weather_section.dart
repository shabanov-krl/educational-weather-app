              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Мое местоположение',
                      style: t.bodyLarge?.copyWith(color: Colors.white70, fontSize: 18),
                  ...
                  Padding(
                    ...
                    child: Text(
                      currentWeather.city,
                      style: t.headlineLarge?.copyWith(color: Colors.white, fontSize: 42),
                      maxLines: 1,
                  ...
                  Padding(
                    ...
                    child: FittedBox(
                      ...
                      child: Text(
                        ...
                        style: t.displayMedium?.copyWith(fontWeight: FontWeight.w200, fontSize: 96),
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: t.headlineSmall?.copyWith(color: Colors.white, fontSize: 24),
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.center,
                    ),
                  ...
                  Text(
                    ...
                    style: t.bodyMedium?.copyWith(color: Colors.white70, fontSize: 16),
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.center,
                  ),
